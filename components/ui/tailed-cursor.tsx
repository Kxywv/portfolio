...
export function TailedCursor({
  ...
  useEffect(() => {
    ...
    colors.forEach((color, index) => {
      // Use exact base properties for precise tracking
      const spring = baseSpring;
      const friction = baseFriction;
      const thickness = baseThickness;
      
      // Calculate exact offset based on index (no randomness)
    ...
    function updateMouse(e: MouseEvent | TouchEvent) {
      ...
      if (!container) return;
      // Use window bounds because we want the cursor to track across the whole screen.
      // But we calculate relative to the container since that's what the shader expects.
